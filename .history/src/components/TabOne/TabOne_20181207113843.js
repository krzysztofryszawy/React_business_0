    ...
    <div className={classes.root}>
      <Grid container direction="row" justify="space-between" alignItems="stretch" spacing={24}>
        ...
        <Grid className={classes.item} item sm={3} xs={12}>
          <ThumbUp className={classes.hoverbtn} style={{ fontSize: 50 }}/>
          <Typography variant="h5" component="h3">
            Be your own kind of beautiful
          </Typography>
          <Typography component="p">
        ...
        <Grid className={classes.item} item sm={3} xs={12}>
          <WatchLater style={{ fontSize: 50, color: '#b89a6a' }}/>
          <Typography variant="h5" component="h3">
            Who We Are
          </Typography>
          <Typography component="p">
        ...
        <Grid className={classes.item} item sm={3} xs={12}>
          <LocalOffer style={{ fontSize: 50, color: '#b89a6a' }}/>
          <Typography variant="h5" component="h3">
            The Team
          </Typography>
          <Typography component="p">
