...
import WallpaperLeftTwo from '../../WallpaperLeftTwo/WallpaperLeftTwo'Two
      ...
      <div className={classes.root}>
        <Grid container direction="row" justify="space-between" alignItems="stretch" spacing={24}>
          ...
          <Grid className={classes.item} item sm={5} xs={12}>
            <PersonPin  style={{ fontSize: 50, color: 'rosybrown' }}/>
            <Typography variant="h5" component="h3">
          ...
          <Grid className={classes.item} item sm={5} xs={12}>
            <Accessible style={{ fontSize: 50, color: 'rosybrown' }}/>
            <Typography variant="h5" component="h3">
