...
import Divider from '../../Divider/Divider'import ImageLeft from '../ImageLeft/ImageLeft'
      ...
      <div className={classes.root}>
        <Grid container direction="row" justify="space-between" alignItems="stretch" spacing={24}>
          ...
          <Grid className={classes.item} item sm={5} xs={12}>
            <LocalAtm style={{ fontSize: 50, color: '#8b783f' }}/>
            <Typography variant="h5" component="h3">
              Hair Cut and Style
            </Typography>
            <Typography component="p">
          ...
          <Grid className={classes.item} item sm={5} xs={12}>
            <Money style={{ fontSize: 50, color: '#8b783f' }}/>
            <Typography variant="h5" component="h3">
